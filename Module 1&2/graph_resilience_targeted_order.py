...
print '\nComputing attack order'
attack_e_graph = fto.fast_targeted_order(e_graph)
attack_er_graph = fto.fast_targeted_order(er_graph)
attack_upa_graph = fto.fast_targeted_order(upa_graph)
...
fig.savefig('resilience_fto.png', dpi=100)
plt.show()

text_file1 = open("e_graph_resilience_fto.txt", "w")
text_file2 = open("er_graph_resilience_fto.txt", "w")
text_file3 = open("upa_graph_resilience_fto.txt", "w")
